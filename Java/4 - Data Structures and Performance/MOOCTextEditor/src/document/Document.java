...
public abstract class Document {
	...
	public double getFleschScore()
	{
		...
		double fleschScore = (206.835 - 1.015*(noWords/noSentences) 
				-84.6*(noSyllables/noWords));
	    return fleschScore;
	}
	
	/*public static void main(String[] args) {
		Document testDoc = new EfficientDocument("Hello my name is.");
		testCase(testDoc, 5, 4, 1);
	}*/
