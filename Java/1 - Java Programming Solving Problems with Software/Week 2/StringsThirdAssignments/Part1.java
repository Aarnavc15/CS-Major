...
public class Part1 {
    ...
    public void testGetAllGenes(){
        String dna1 = "ATGxxxTAAxATGxxxTAG";
        StorageResource List = getAllGenes(dna1);
        System.out.println("Finding the genes in the dna sequence: " + dna1);
        
        for (String gene : List.data()){
